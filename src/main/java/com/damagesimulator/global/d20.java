...
public class d20 {
    ...
    public int roll(com.damagesimulator.global.Advantage advantage) {
        if (advantage == com.damagesimulator.global.Advantage.ADVANTAGE) return rollAdvantage();
        else if (advantage == com.damagesimulator.global.Advantage.DISADVANTAGE) return rollDisadvantage();
        else return roll();
    }
