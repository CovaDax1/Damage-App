...
public abstract class BaseCharacter<W extends Weapon> {
    ...
    public int getStrengthSave() {
        return getStrength().getMod() + (strengthSave ? getProficiency() : 0);
    }
    ...
    public int getDexteritySave() {
        return getDexterity().getMod() + (dexteritySave ? getProficiency() : 0);
    }
    ...
    public int getConstitutionSave() {
        return getConstitution().getMod() + (constitutionSave ? getProficiency() : 0);
    }
    ...
    public int getIntelligenceSave() {
        return getIntelligence().getMod() + (intelligenceSave ? getProficiency() : 0);
    }
    ...
    public int getWisdomSave() {
        return getWisdom().getMod() + (wisdomSave ? getProficiency() : 0);
    }
    ...
    public int getCharismaSave() {
        return getCharisma().getMod() + (charismaSave ? getProficiency() : 0);
    }
