...
//        System.out.println("\n\n\n");
    ...
    public static void testTheNightblade() {
        ...
        TheNightbladeGWM nightbladeGWM = TheNightbladeGWM.build(8, 14, 16, 10, 8, 20);
        nightbladeGWM.levelUp(BaseClass.WARLOCK, 5);
        nightbladeGWM.levelUp(BaseClass.SORCERER, 4);
        nightbladeGWM.bondHexWeapon(new Greatsword(2));
        nightbladeGWM.equipArmor(new Scale());
        nbList.put("The Nightblade - Great Weapon Master", nightbladeGWM);
        TheNightbladePM nightbladePM = TheNightbladePM.build(8, 14, 16, 10, 8, 20);
        nightbladePM.levelUp(BaseClass.WARLOCK, 5);
        nightbladePM.levelUp(BaseClass.SORCERER, 4);
        nightbladePM.bondHexWeapon(new Glaive(2));
        ...
        nightbladeGPM.levelUp(BaseClass.SORCERER, 4);
        nightbladeGPM.bondHexWeapon(new Glaive(2));
